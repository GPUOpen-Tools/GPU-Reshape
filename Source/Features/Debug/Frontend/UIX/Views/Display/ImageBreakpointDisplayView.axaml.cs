...
public partial class ImageBreakpointDisplayView : UserControl, IViewFor
{
    ...
    /// </summary>
    private void OnLayoutChanged(ImageBreakpointDisplayViewModel vm)
    {
    ...
    /// </summary>
    private void OnContentChanged(ImageBreakpointDisplayViewModel vm)
    {
    ...
    /// </summary>
    private void OnZoomPointerWheel(ImageBreakpointDisplayViewModel vm, PointerWheelEventArgs e)
    {
        if (vm.LockToContent)
        {
    ...
    /// </summary>
    private void UpdateInterpolationMode(ImageBreakpointDisplayViewModel vm)
    {
        // Get the source dimensions
        double sourceWidth = vm.Image?.Size.Width ?? 1;
        double sourceHeight = vm.Image?.Size.Height ?? 1;
    ...
    /// </summary>
    private void OnZoomPointerPressed(ImageBreakpointDisplayViewModel vm, PointerPressedEventArgs e)
    {
        if (vm.LockToContent)
        {
            vm.LockToContent = false;
    ...
    /// </summary>
    private void OnZoomPointerReleased(ImageBreakpointDisplayViewModel vm, PointerReleasedEventArgs e)
    {
        if (!_isZoomDragging)
        {
            return;
    ...
    /// </summary>
    private void OnZoomPointerMoved(ImageBreakpointDisplayViewModel vm, PointerEventArgs e)
    {
        if (_isZoomDragging)
        {
            // Current offset
