...
public class BreakpointStackTreeItemViewModel : ReactiveObject, IObservableTreeItem
{
    /// <summary>
    ...
    /// </summary>
    public BreakpointValueReconstructionState ReconstructionState { get; set; }
    ...
    /// Internal text state
    /// </summary>
    private string _text = "BreakpointStackTreeItemViewModel";
