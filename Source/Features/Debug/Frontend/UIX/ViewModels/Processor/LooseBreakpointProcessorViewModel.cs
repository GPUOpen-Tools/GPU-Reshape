...
public class LooseBreakpointProcessorViewModel : IBreakpointProcessorViewModel
{
    /// <summary>
    ...
    public void Install(IBreakpointDisplayViewModel displayViewModel, object payload)
    {
        ...
        // Assign contents
        if (displayViewModel is LooseBreakpointDisplayViewModel looseDisplayViewModel)
        {
